...
def your_sanity_checks():
    ...
    """
    quad1 = lambda x: (np.sum(x ** 2), x * 2)
    print ("Running your sanity checks...")
    ### YOUR CODE HERE
    gradcheck_naive(quad1, np.array(123.456))      # scalar test
    gradcheck_naive(quad1, np.random.randn(3,))    # 1-D test
    gradcheck_naive(quad1, np.random.randn(4,5))   # 2-D test
